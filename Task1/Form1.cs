...
namespace Task1
{
    public partial class Form1 : Form
    {
        ...
        private void Add_Button_Click(object sender, EventArgs e)
        {
            ...
            Add_dialog.Add_dialog( DB.question_table().Clone(), next_order);//call ShowDialog method from class Add_dialog
        ...
        private void Edit_Button_Click(object sender, EventArgs e)
        {
            if (!isEmpty())//check if data grid view is empty to return index of selected row 
            {
                ...
                edit_Dialog.Edit_dialog(order,rows[0],rows[1]);//call method ShowDialog that take question order and datatable and index of selected row 
